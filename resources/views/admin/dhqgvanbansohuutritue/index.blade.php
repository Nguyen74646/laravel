...
<div class="container mt-4">
    <h3 class="mb-4">Danh sách văn bản sở hữu trí tuệ để quản lý mới</h3>
    ...
    {{-- Nút thêm mới --}}
    <a href="{{ route('admin.dhqgvanbansohuutritue.create') }}" class="btn btn-primary mb-3">➕ Thêm văn bản biểu mẫu mới</a>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle text-center">
            ...
            <tbody>
                @forelse($dhqgvanbansohuutritue as $hoso)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <a href="{{ route('admin.dhqgvanbansohuutritue.edit', $hoso->id) }}" class="btn btn-sm btn-primary" title="Sửa">✏️</a>
                                <form action="{{ route('admin.dhqgvanbansohuutritue.destroy', $hoso->_id) }}"  method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
...
{{-- Phân trang --}}
@foreach($dhqgvanbansohuutritue as $hoso)
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content shadow-lg rounded-3">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="viewModalLabel-{{ $hoso->id }}">📄 Chi tiết Thông báo này nè</h5>
