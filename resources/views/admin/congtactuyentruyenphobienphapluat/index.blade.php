...
<div class="container mt-4">
    ...
    {{-- Nút thêm mới --}}
    <a href="{{ route('admin.congtactuyentruyenphobienphapluat.create') }}" class="btn btn-primary mb-3">➕ Thêm công tác mới</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <a href="{{ route('admin.congtactuyentruyenphobienphapluat.edit', $hoso->id) }}" class="btn btn-sm btn-primary" title="Sửa">✏️</a>
                                <form action="{{ route('admin.congtactuyentruyenphobienphapluat.destroy', $hoso->_id) }}"  method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
