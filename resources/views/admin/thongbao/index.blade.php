...
<div class="container mt-4">
    <h3 class="mb-4">Danh sách thông báo mới</h3>
    ...
    {{-- Nút thêm mới --}}
    <a href="{{ route('admin.thongbao.create') }}" class="btn btn-primary mb-3">➕ Thêm công tác mới</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <a href="{{ route('admin.thongbao.edit', $hoso->id) }}" class="btn btn-sm btn-primary" title="Sửa">✏️</a>
                                <form action="{{ route('admin.thongbao.destroy', $hoso->_id) }}"  method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <p><strong>Nội dung:</strong> {!! $hoso->content!!}</p>
                            </div>
