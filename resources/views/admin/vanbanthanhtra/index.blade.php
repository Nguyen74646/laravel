...
<div class="container mt-4">
    <h3 class="mb-4">Danh sách thanh tra nhá </h3>
    ...
    {{-- Nút thêm mới --}}
    <a href="{{ route('admin.vanbanthanhtra.create') }}" class="btn btn-primary mb-3">➕ Thêm hồ sơ mới</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <a href="{{ route('admin.vanbanthanhtra.edit', $hoso->id) }}" class="btn btn-sm btn-primary" title="Sửa">✏️</a>
                                <form action="{{ route('admin.vanbanthanhtra.destroy', $hoso->_id) }}"  method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
