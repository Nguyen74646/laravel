...
<div class="container mt-4">
    <h3 class="mb-4">Danh sách kế hoạch công văn cần quản lý mới</h3>
    ...
    {{-- Nút thêm mới --}}
    <a href="{{ route('admin.shttkehoachcongvan.create') }}" class="btn btn-primary mb-3">➕ Thêm văn bản biểu mẫu mới</a>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle text-center">
            ...
            <tbody>
                @forelse($shttkehoachcongvan as $hoso)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <a href="{{ route('admin.shttkehoachcongvan.edit', $hoso->id) }}" class="btn btn-sm btn-primary" title="Sửa">✏️</a>
                                <form action="{{ route('admin.shttkehoachcongvan.destroy', $hoso->_id) }}"  method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
...
{{-- Phân trang --}}
@foreach($shttkehoachcongvan as $hoso)
