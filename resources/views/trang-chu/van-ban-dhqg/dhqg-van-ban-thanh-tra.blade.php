...
<section class="col">
                <div class="container mt-5">
                    ...
                    {{-- Tiêu đề --}}
                    <h2 class="text-center fw-bold text-dark mb-3">VĂN BẢN THANH TRA ĐẠI HỌC QUỐC GIA</h2>
                        ...
                        <tbody>
                            @forelse ($nguyen as $document)
                                <tr style="border-bottom: 1px solid #dee2e6;">
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('trang-chu.van-ban-dhqg.show-dhqgvanbanthanhtra', $document->_id) }}"                       
