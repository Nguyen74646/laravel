<h4 class="text-center my-4 fw-bold">TIN TỨC - SỰ KIỆN MỚI NHẤT</h4>

<div class="container">
    <div class="row">
        @forelse ($tin_moi_nhat as $item)
    ...
    {{-- trong tin_moi_nhat.blade.php --}}
    <div class="d-flex justify-content-center mt-4">
        {{ $tin_moi_nhat->appends(['type' => 'tin'])->links('pagination::bootstrap-5') }}
    </div>
