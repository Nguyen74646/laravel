...
<section class="col">
                <div class="container mt-5">
                    ...
                    {{-- Tiêu đề --}}
                    <h2 class="text-center fw-bold text-dark mb-3">VĂN BẢN PHÁP CHẾ QUY PHẠM PHÁP LUẬT</h2>
                            ...
                            <tbody>
                                @forelse ($thongbao as $document)
                                    <tr style="border-bottom: 1px solid #dee2e6;">
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('trang-chu.van-ban-quy-pham-phap-luat.show-vanbanphapche', $document->_id) }}"                       
