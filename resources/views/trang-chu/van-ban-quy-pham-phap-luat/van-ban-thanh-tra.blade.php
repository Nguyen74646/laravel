...
<section class="col">
                ...
                {{-- Tiêu đề --}}
                <h2 class="text-center fw-bold text-dark mb-3">VĂN BẢN THANH TRA QUY PHẠM PHÁP LUẬT</h2>
                    ...
                    <tbody>
                        @forelse ($nguyen as $document)
                            <tr style="border-bottom: 1px solid #dee2e6;">
                                ...
                                <td class="text-end">
                                    <a href="{{ route('trang-chu.van-ban-quy-pham-phap-luat.show-vanbanthanhtra', $document->_id) }}"                       
