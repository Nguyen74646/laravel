...
<section class="col">
                <div class="container mt-5">
                    ...
                    {{-- Tiêu đề --}}
                    <h2 class="text-center fw-bold text-dark mb-3">QUY TRÌNH - QUY ĐỊNH SỞ HỮU TRÍ TUỆ</h2>
                                ...
                                @forelse ($nguyen as $document)
                                    <tr style="border-bottom: 1px solid #dee2e6;">
                                        ...
                                        {{-- <a href="{{ route('hoso.show', $document->_id) }}" --}}
                                            <a href="{{ Route('trang-chu.so-huu-tri-tue.show-shttquytrinh', ['id' => $document->_id]) }}" 
